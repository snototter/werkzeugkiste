...
#
# This file has been copied from the CMake Community Modules:
...
# If we're not cross-compiling, try to run test executables. Otherwise, assume
# that compile + link is a sufficient check.
...
foreach(component IN LISTS extra_components)
  message(
    WARNING "Extraneous find_package component for Filesystem: ${component}")
endforeach()
...
elseif(_CXX_FILESYSTEM_HAVE_EXPERIMENTAL_HEADER)
  ...
  set(_have_fs FALSE)
  # Set dummy values to avoid CMake errors (in strict mode)
  set(_fs_header "")
  set(_fs_namespace "")
  set(_is_experimental TRUE)
endif()
