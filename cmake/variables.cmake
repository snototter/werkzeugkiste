...
# only relevant for the developer(s) of werkzeugkiste Targets necessary to build
# the project must be provided unconditionally, so consumers can trivially build
# and package the project
if(PROJECT_IS_TOP_LEVEL)
  option(werkzeugkiste_DEVELOPER_MODE "Enable developer mode" OFF)
...
#else
#  define WERKZEUGKISTE_SUPPRESS_C4251
#endif
")
...
if(NOT PROJECT_IS_TOP_LEVEL)
  option(werkzeugkiste_INCLUDES_WITH_SYSTEM
         "Use SYSTEM modifier for werkzeugkiste's includes, disabling warnings"
         ON)
  mark_as_advanced(werkzeugkiste_INCLUDES_WITH_SYSTEM)
  if(werkzeugkiste_INCLUDES_WITH_SYSTEM)
