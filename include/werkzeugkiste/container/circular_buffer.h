#ifndef WERKZEUGKISTE_CONTAINER_CIRCULAR_BUFFER_H
#define WERKZEUGKISTE_CONTAINER_CIRCULAR_BUFFER_H
...
public:
  ...
  // Overloaded - operator.
  difference_type operator-(const self_type& c) const { return pos_ - c.pos_; }
